...
# part imports
from Workflow_0.parts.Readers import Reader
from Workflow_0.parts.Tools import run_init
from Workflow_0.parts.Tools import performance_plot
from Workflow_0.parts.Networks import Net
from Workflow_0.parts.Evaluation import Evaluator
from Workflow_0.parts.Evaluation import Heatmap
...
class Workflow:
    ...
    def load_data(self):
        ...
        self.loader_1 = self.get_loader(self.path['set_1'], self.path['labeled'], augment=False, eval=False, batch_size=self.hparam['batch_size'], shuffle=True) # cause why not shuffle?
